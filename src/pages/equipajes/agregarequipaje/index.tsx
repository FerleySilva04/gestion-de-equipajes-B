    ...
    <div className="min-h-screen flex flex-col justify-between">
      ...
      <main className="flex-grow flex flex-col items-center justify-start text-center p-4 space-y-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 w-full md:max-w-6xl">
          <FormHeader title="Añadir equipaje" />
          ...
          <div className="flex justify-end mt-8 space-x-4">
            {/* Botón de cancelar con id único */}
            <Button
              type="button"
              className="bg-white text-black"
              id="cancel"  // id basado en la acción del botón
            >
              Cancelar
            </Button>

            {/* Botón de añadir equipaje con id único */}
            <Button
              type="submit"
              className="bg-[#10a4ec] text-white rounded-md"
              id="add-luggage"  // id basado en la acción del botón
            >
              Añadir Equipaje
            </Button>
          </div>
